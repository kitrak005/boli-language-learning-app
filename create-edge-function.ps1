New-Item -ItemType Directory -Path ".\supabase\functions\generate-battle-questions" -Force | Out-Null
...
'@ | Set-Content -Path ".\supabase\functions\generate-battle-questions\index.ts" -Encoding utf8

Write-Host "Created supabase\functions\generate-battle-questions\index.ts"
