...
export const ProfileView: React.FC<ProfileViewProps> = ({ profile }) => {
  ...
  return (
    <div className="space-y-8 max-w-xl mx-auto pb-12 animate-in fade-in duration-300">
      {/* Profile Bento Summary */}
      <section className="grid grid-cols-2 gap-4">
        {/* Avatar Card */}
        <div className="col-span-2 flex items-center gap-4 p-6 bg-[#121212] rounded-2xl shadow-xl border border-white/10">
          <div
            className="w-[72px] h-[72px] rounded-full bg-cover bg-center shrink-0 border-2 border-[#C5A059] shadow-md"
            style={{
        ...
        {/* Total XP */}
        <div className="col-span-1 bg-[#161616] rounded-2xl p-5 flex flex-col justify-center shadow-lg border border-white/10">
        ...
        <div className="col-span-1 bg-[#161616] rounded-2xl p-5 flex flex-col justify-center shadow-lg border border-white/10">
          ...
          <span className="font-serif text-2xl sm:text-3xl font-normal text-[#C5A059]">
